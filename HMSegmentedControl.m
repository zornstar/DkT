...
- (void)setDefaults {
    ...
    self.selectionIndicatorBoxLayer.opacity = 1; //change made by mz
    self.selectionIndicatorBoxLayer.borderWidth = 0.0f; //change made by mz
    self.selectionIndicatorBoxLayer.cornerRadius = 0.0f; //change made by mz
}
